...
class RWKV_TimeMix(nn.Module):
    def __init__(self, n_embed):
        ...
        self.gate = nn.Linear(n_embed, n_embed, bias=False)
...
class RWKV_V5_Infer_For_CoreML(nn.Module):
    def __init__(self,
                 vocab_size=2000,
                 hidden_size=512,
                 num_hidden_layers=4,
        ...
        super(RWKV_V5_Infer_For_CoreML, self).__init__()
...
class RWKV_V5_Infer_For_ONNX(nn.Module):
    def __init__(self,
                 vocab_size=2000,
                 hidden_size=512,
                 num_hidden_layers=4,
        ...
        super(RWKV_V5_Infer_For_ONNX, self).__init__()
        self.hidden_size = hidden_size
        self.num_hidden_layers = num_hidden_layers
...
class RWKV_V5_Infer_For_Script(nn.Module):
    def __init__(self,
                 vocab_size=2000,
                 hidden_size=512,
                 num_hidden_layers=4,
        ...
        super(RWKV_V5_Infer_For_Script, self).__init__()
        self.hidden_size = hidden_size
        self.num_hidden_layers = num_hidden_layers
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='rwkv_v5_infer_for_coreml')
def build_rwkv_v5_infer_for_coreml(args):
    model = RWKV_V5_Infer_For_CoreML(
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='rwkv_v5_infer_for_onnx')
def build_rwkv_v5_infer_for_onnx(args):
    model = RWKV_V5_Infer_For_ONNX(
        vocab_size = args.vocab_size,
        hidden_size = args.hidden_size,
        num_hidden_layers = args.num_hidden_layer,
        intermediate_size = args.intermediate_size
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='rwkv_v5_infer_for_script')
def build_rwkv_v5_infer_for_script(args):
    model = RWKV_V5_Infer_For_Script(
        vocab_size = args.vocab_size,
        hidden_size = args.hidden_size,
        num_hidden_layers = args.num_hidden_layer,
        intermediate_size = args.intermediate_size

...
class RWKV_TC_Infer_For_CoreML(nn.Module):
    def __init__(self,
                 vocab_size=2000,
                 hidden_size=512,
                 num_hidden_layers=4,
        ...
        super(RWKV_TC_Infer_For_CoreML, self).__init__()
...
class RWKV_TC_Infer_For_ONNX(nn.Module):
    def __init__(self,
                 vocab_size=2000,
                 hidden_size=512,
                 num_hidden_layers=4,
        ...
        super(RWKV_TC_Infer_For_ONNX, self).__init__()
        self.hidden_size = hidden_size
        self.num_hidden_layers = num_hidden_layers
...
class RWKV_TC_Infer_For_Script(nn.Module):
    def __init__(self,
                 vocab_size=2000,
                 hidden_size=512,
                 num_hidden_layers=4,
        ...
        super(RWKV_TC_Infer_For_Script, self).__init__()
        self.hidden_size = hidden_size
        self.num_hidden_layers = num_hidden_layers
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='rwkv_tc_infer_for_coreml')
def build_rwkv_tc_infer_for_coreml(args):
    model = RWKV_TC_Infer_For_CoreML(
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='rwkv_tc_infer_for_onnx')
def build_rwkv_tc_infer_for_onnx(args):
    model = RWKV_TC_Infer_For_ONNX(
        vocab_size = args.vocab_size,
        hidden_size = args.hidden_size,
        num_hidden_layers = args.num_hidden_layer,
        intermediate_size = args.intermediate_size
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='rwkv_tc_infer_for_script')
def build_rwkv_tc_infer_for_script(args):
    model = RWKV_TC_Infer_For_Script(
        vocab_size = args.vocab_size,
        hidden_size = args.hidden_size,
        num_hidden_layers = args.num_hidden_layer,
        intermediate_size = args.intermediate_size

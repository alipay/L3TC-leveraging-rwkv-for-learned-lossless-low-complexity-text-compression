...
class RWKV_ChannelMix(nn.Module):
    def __init__(self, n_embed, ffn_dim, rwkv_rank):
        super().__init__()
...
class RWKV_TimeMix(nn.Module):
    def __init__(self, n_embed, rwkv_rank):
        super().__init__()
        ...
        high_rank = int(n_embed * rwkv_rank)
        self.key_A = nn.Linear(n_embed, high_rank, bias=False)
        self.key_B = nn.Linear(high_rank, n_embed, bias=False)
...
class Block(nn.Module):
    def __init__(self, layer_id, n_embed, ffn_dim, rwkv_rank):
        super().__init__()
        ...
        self.att = RWKV_TimeMix(n_embed, rwkv_rank)
        self.ffn = RWKV_ChannelMix(n_embed, ffn_dim, rwkv_rank)
...
class Block_ONNX(nn.Module):
    def __init__(self, layer_id, n_embed, ffn_dim, rwkv_rank):
        ...
        self.att = RWKV_TimeMix_ONNX(n_embed, rwkv_rank)
        self.ffn = RWKV_ChannelMix(n_embed, ffn_dim, rwkv_rank)
        self.short = nn.Linear(n_embed, n_embed, bias=False)
...
class RWKV_TC_HIRA_Infer_For_CoreML(nn.Module):
    def __init__(self,
                 vocab_size=2000,
                 hidden_size=512,
                 num_hidden_layers=4,
        ...
        super(RWKV_TC_HIRA_Infer_For_CoreML, self).__init__()
        self.hidden_size = hidden_size
        self.num_hidden_layers = num_hidden_layers

        self.emb = nn.Embedding(vocab_size, hidden_size)
        self.blocks = nn.ModuleList([Block(i, hidden_size, intermediate_size, rwkv_rank) for i in range(num_hidden_layers)])
...
class RWKV_TC_HIRA_Infer_For_ONNX(nn.Module):
    def __init__(self,
                 vocab_size=2000,
                 hidden_size=512,
                 num_hidden_layers=4,
        ...
        super(RWKV_TC_HIRA_Infer_For_ONNX, self).__init__()
        self.hidden_size = hidden_size
        self.num_hidden_layers = num_hidden_layers

        self.emb = nn.Embedding(vocab_size, hidden_size)
        self.blocks = nn.ModuleList([Block_ONNX(i, hidden_size, intermediate_size, rwkv_rank) for i in range(num_hidden_layers)])
        self.ln_out = nn.LayerNorm(hidden_size)
        self.head = nn.Linear(hidden_size, vocab_size, bias=False)
...
class RWKV_TC_HIRA_Infer_For_Script(nn.Module):
    def __init__(self,
                 vocab_size=2000,
                 hidden_size=512,
                 num_hidden_layers=4,
        ...
        super(RWKV_TC_HIRA_Infer_For_Script, self).__init__()
        self.hidden_size = hidden_size
        self.num_hidden_layers = num_hidden_layers

        self.emb = nn.Embedding(vocab_size, hidden_size)
        self.ln0 = nn.LayerNorm(hidden_size)
        self.blocks = nn.ModuleList([Block_Script(hidden_size, intermediate_size, rwkv_rank) for i in range(num_hidden_layers)])
        self.ln_out = nn.LayerNorm(hidden_size)
        self.head = nn.Linear(hidden_size, vocab_size, bias=False)
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='rwkv_tc_hira_infer_for_coreml')
def build_rwkv_tc_hira_infer_for_coreml(args):
    model = RWKV_TC_HIRA_Infer_For_CoreML(
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='rwkv_tc_hira_infer_for_onnx')
def build_rwkv_tc_hira_infer_for_onnx(args):
    model = RWKV_TC_HIRA_Infer_For_ONNX(
        vocab_size = args.vocab_size,
        hidden_size = args.hidden_size,
        num_hidden_layers = args.num_hidden_layer,
        intermediate_size = args.intermediate_size,
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='rwkv_tc_hira_infer_for_script')
def build_rwkv_tc_hira_infer_for_script(args):

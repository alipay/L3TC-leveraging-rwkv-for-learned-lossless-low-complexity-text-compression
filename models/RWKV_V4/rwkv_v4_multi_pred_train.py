...
class RWKV_V4_Multi_Pred(nn.Module):
    def __init__(self,
                 vocab_size = 2000,
                 hidden_size = 512,
                 num_hidden_layers = 4,
        ...
        super(RWKV_V4_Multi_Pred, self).__init__()
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='rwkv_v4_multi_pred')
def build_rwkv_v4_multi_pred(args):
    model = RWKV_V4_Multi_Pred(
